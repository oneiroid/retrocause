# Retrocause: Formal Model v1 (SUPERSEDED)

> **Historical artifact.** This is the original axiomatic draft of the
> Retrocause formal model. It has been **superseded by
> `FORMAL_MODEL.md`** (the v2 rebase on Lessard & Levison's threaded-DAG
> formalism), which replaces the abstract topology talk here with
> concrete typed expressions, subDAGs, and operators.
>
> Kept in `prior_research/` for traceability: v2's concept lineage
> (axioms A1–A5, definitions D1–D8, the "two graphs" distinction) all
> originate here.
>
> Do not extend or cite this document for new work. Reference
> `FORMAL_MODEL.md` instead.
